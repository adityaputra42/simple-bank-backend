...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_create_user.proto\x1a\x15rpc_update_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xa6\x03\n" +
	"\n" +
	...
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"I\x92A,\x12\vUpdate User\x1a\x1dUse this Api to update a user\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/update_user\x12~\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"D\x92A-\x12\x0flogin user User\x1a\x1aUse this Api to login user\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/loginB{\x92Ah\x12f\n" +
	"\vSimple Bank\"R\n" +
	"\x14Aditya Putra Pratama\x12 https://github.com/adityaputra42\x1a\x18aditiyaputra42@gmail.com2\x031.2Z\x0esimple-bank/pbb\x06proto3"
