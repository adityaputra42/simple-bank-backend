...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_create_user.proto\x1a\x15rpc_update_user.proto\x1a\x16rpc_verify_email.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xb3\x04\n" +
	"\n" +
	...
	"login User\x1a\x1aUse this Api to login user\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/login\x12\x8f\x01\n" +
	"\vVerifyEmail\x12\x16.pb.VerifyEmailRequest\x1a\x17.pb.VerifyEmailResponse\"O\x92A4\x12\fVerify email\x1a$Use this Api to verify email address\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/verify_emailB{\x92Ah\x12f\n" +
	"\vSimple Bank\"R\n" +
